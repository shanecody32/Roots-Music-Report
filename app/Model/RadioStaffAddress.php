<?php
class RadioStaffAddress extends AppModel {
	var $name = 'RadioStaffAddress';
	...
	function checkCountry($data, $check){
		if($this->data['RadioStaffAddress']['country_id'] == 225 || $this->data['RadioStaffAddress']['country_id'] == 39){
			if(empty($this->data['RadioStaffAddress']['state'])){
				return false;
			}
		}
		return true;
