...
class AppController extends Controller {
	var $helpers = array('Html', 'Format', 'Session', 'Js' => array('Jquery'),'Display', 'Time', 'Form', 'Logic', 'Link','Cropimage','Image');
    ...
    public function beforeFilter() {
		...
		$this->set('l_genres', $this->Genre->find('all', array('order'=>array('Genre.name'=>'ASC'))));
		$this->loadModel('SubGenre');
		$this->SubGenre->recursive = -1;
		$this->set('l_sub_genres', $this->SubGenre->find('all', array('order'=>array('SubGenre.name'=>'ASC'))));
		$this->loadModel('State');
		$this->State->recursive = -1;
		$this->set('states', $this->State->find('all', array('order'=>array('State.name'=>'ASC'), 'conditions' => array('country_id'=>225))));
