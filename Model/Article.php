...
class Article extends AppModel {
	...
	var $validate = array(
		...
		'title' => array(
			...
			'between' => array(
                'rule'    => array('between', 0, 76),
                'message' => 'Maximum of 76 characters'
            )
		),
	);
	...
	var $filterArgs = array(
		...
		array('name' => 'categories', 'type' => 'subquery', 'field'=>'Article.category_id', 'method'=>'filterCategories'),
...
//			'contain' => array('SubGenre'), // additional containable info if needed
	...
	function filterCategories($data){
		$sub_genre_model = ClassRegistry::init('Category');
        $sub_genre_model->Behaviors->attach('Search.Searchable'); 
		$query = $sub_genre_model->getQuery('all', array(
			'conditions' => array('Category.id'  => $data['categories']),
