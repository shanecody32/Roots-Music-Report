...
<section id="results">	
	...
	<? foreach($articles as $article): ?>
				<article class="article">
					<h4 class="article-title">
						...
						<?=$this->Html->link($article['Article']['title'], array('controller' => 'articles', 'action'=>'view', $article['Article']['id'])); ?></h4>
	...
	<? 
		...
		$string = substr($stringCut, 0, strrpos($stringCut, ' ')).'... '.$this->Html->link(__('Read More'), array('controller'=>'articles', 'action'=>'view', $article['Article']['id']));
